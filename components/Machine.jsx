      ...
      <div className="absolute flex w-full h-4/5 top-1/2 -translate-y-1/2">
        ...
        <div className="relative right w-1/2 h-full ">
          <div className="absolute space-y-0 block w-4/5 right-0 h-full">
            ...
            <div className="absolute w-full space-y-2 h-1/3 bottom-0 space">
              <div className="h-14 p-4 space-x-2 flex bg-bgGrayBorder rounded-lg">
                <img src="/assets/bg.png" className="w-6" />
                <p className="font-title text-Header text-sm">
